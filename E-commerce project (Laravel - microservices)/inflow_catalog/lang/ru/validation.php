...
return [
    ...
    */
    ...
    'document'             => [
        'cant_be_signed' => 'Документ не может быть подписан.',
        'already_signed' => 'Документ уже подписан.',
        'you_cant_sign'  => 'Вы не можете подписать этот документ.',
        'no_file' => 'Документ не содержит файл для подписи.',
        'no_signature' => 'Документ не содержит файл подписи.'
    ],
    'weekday' => 'Дата должна быть рабочим днём',
    ...
    */
    ...
    'custom' => [
        ...
        'array_length' => 'Неверное количество элементов'
    ],
