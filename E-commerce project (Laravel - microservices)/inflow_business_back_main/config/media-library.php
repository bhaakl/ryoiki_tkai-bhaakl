...
return [
     ...
     */
    'file_namer' => \App\Services\Media\CustomFileNamer::class,

    /*
     * The class that contains the strategy for determining a media file's path.
     */
    'path_generator' => \App\Services\Media\CustomPathGenerator::class,
    ...
    'preview_width' => env('PREVIEW_WIDTH', 400),
    'preview_height' => env('PREVIEW_HEIGHT', 400),
];
