  ...
  <div class="card">
    <div class="card-header d-flex flex-row justify-content-between">
      <p class="font-weight-bold">
        Вопрос {{ index }}<span> (с одним вариантом ответа)</span>
      </p>
      <CButton
        v-if="!group_name"
        color="light"
    ...
    <div class="card-body">
      <CInputCheckbox
        label="Обязательsное комментирование ответа"
...
export default {
  ...
  methods: {
    ...
    resetOptions() {
      if (!this.questionListItems[this.questionId]) {
        this.$set(this.questionListItems, this.questionId, {})
      }

      this.$set(this.questionListItems[this.questionId], 'blackList', [])
      this.$set(this.questionListItems[this.questionId], 'optionList', [])
      this.questionListItems = { ...this.questionListItems }

      this.manageOptions()
      this.$emit('optionsManaged')
    },
    manageOptions() {
