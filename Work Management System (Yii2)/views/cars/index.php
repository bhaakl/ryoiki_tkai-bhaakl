...
/* @var $searchModel app\models\Car */
/* @var $dataProvider yii\data\ActiveDataProvider */
/* @var $formModel \app\models\forms\CarsForm */
/* @var $data array */
    ...
    'columns' => [
        [
            ...
            'value' => function($model) use ($can_update) {
                return $can_update ? Html::dropDownList('type_id', $model->type_id ?? null,
                    CarType::listAll('id', 'name'), ['class' => 'form-control form-select select2', 'prompt' => 'Выберите']) : $model->type->name ?? '';
            },
        ],
        [
            'attribute' => 'name',
