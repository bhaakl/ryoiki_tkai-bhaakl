...
/* @var $model app\models\ProductionLocation */
...
<div class="form-search">
    ...
    <div class="row search-block">
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <?= $form->field($model, 'category_id')->dropDownList(ProductionLocationCategory::listAll('id', 'name'), ['class' => 'form-select select2', 'prompt' => 'Все']) ?>
        </div>
		<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <?= $form->field($model, 'name')->textInput(['maxlength' => true, 'id' => 'period', 'autocomplete' => 'off']) ?>
        </div>
		<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
