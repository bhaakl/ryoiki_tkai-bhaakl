...
<head>
    ...
    <title>Печать задания на производство гибочных изделий</title>
...
<body onload="onPageLoaded()">
    <h3>Производственное задание на изготовление гибочных изделий</h3>
    <table class="top-spacing">
        <tbody>
            <tr class="border-top2">
                ...
                <td><?= $model['number'] ?></td>
                <td></td>
                <td rowspan="6" class="direction"><?= $data['direction'] ?></td>
            </tr>
            <tr>
            ...
            <tr class="border-top2">
                ...
                <td colspan="3" class="bold"><?= $model['productName'] ?></td>
            </tr>
            <tr class="border-top2">
                <td colspan="2"></td>
                <td>Толщина, мм</td>
            ...
            <tr>
                <td colspan="2"></td>
                <td class="bold"><?= $data['thickness'] ?></td>
                <td class="bold"><?= $data['coating'] ?></td>
                <td class="bold"><?= $data['outer_color'] ?></td>
            </tr>
    ...
    <table class="top-spacing">
        <tbody>
            ...
            <tr class="no-border">
                ...
                <td class="bold align-right border-dotted"><?= $data['length_total'] ?></td>
                <td></td>
            </tr>
        </tbody>
    </table>
    ...
    <table class="top-spacing">
        <tbody>
            ...
            <tr>
                ...
                <td class="bold"><?= $data['thickness'] ?></td>
                <td class="bold"><?= $data['coating'] ?></td>
                <td class="bold"><?= $model['outer_color'] ?></td>
                <td class="bold"><?= NumberHelper::cropDecimals($data['area_total']) ?></td>
            </tr>
        </tbody>
    </table>
    ...
    <table class="top-spacing">
        <tbody>
            <tr class="border-top2">
                ...
                <td class="border">Развертка</td>
                <td class="border">Длина</td>
                <td class="border">Ширина</td>
                <td class="border">Толщина</td>
            </tr>
            <tr class="border-top2">
                <td class="border">&nbsp;</td>
                <td class="border">&nbsp;</td>
