...
$this->title = 'Печать задания на производство ' . $model->product->category->name;
?>
...
<table>
    <tr>
        ...
        <td class="right-column">
            <iframe src="<?= Url::to(['production-tickets/print', 'id' => $model->id, 'stage' => ProductionStage::STAGE_ARCH4521]) ?>" id="preview"></iframe>
        </td>
    </tr>
</table>
