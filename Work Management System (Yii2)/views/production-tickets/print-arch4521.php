...
<head>
    ...
    <title>Печать задания на производство арки</title>
...
<body onload="onPageLoaded()">
    <h3>Производственное задание на изготовление <?= $model['productCategoryName'] ?></h3>
    <table class="top-spacing">
        <tbody>
            ...
            <tr>
                <td colspan="2"></td>
                <td class="bold"><?= $model['arch_thickness'] ?></td>
                <td class="bold"><?= $data['coating'] ?></td>
                <td class="bold"><?= $model['arch_color'] ?></td>
            </tr>
    ...
    <table class="top-spacing">
        <tbody>
            <tr class="border-top2">
                ...
                <td class="border">Хорда</td>
                <td class="border">Высота</td>
                <td class="border">Прямой участок</td>
            </tr>
            <tr class="border-top2">
                <td class="border">&nbsp;</td>
                <td class="border">&nbsp;</td>
