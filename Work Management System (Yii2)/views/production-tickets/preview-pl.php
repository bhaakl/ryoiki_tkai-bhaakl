...
$this->title = 'Печать задания на производство плоского листа (штрипс)';
?>
...
<table>
    <tr>
        ...
        <td class="right-column">
            <iframe src="<?= Url::to(['production-tickets/print', 'id' => $model->id, 'stage' => ProductionStage::STAGE_PL]) ?>" id="preview"></iframe>
        </td>
    </tr>
</table>
