...
$this->title = 'Печать задания на производство утеплителя';
?>
...
<table>
    <tr>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6">
                        <div class="form-group">
                            ...
                            <?= MaskedInput::widget([
                                'name' => 'density',
                                'value' => 0,
                                'clientOptions' => NumberHelper::WEIGHT_INPUT_CONFIG,
                            ]) ?>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-6">
                        <div class="form-group">
                            <label class="control-label">Вес м<sup>3</sup></label>
                            <?= MaskedInput::widget([
                                'name' => 'weight_m3',
                                'value' => 0,
                                'clientOptions' => NumberHelper::WEIGHT_INPUT_CONFIG,
        ...
        <td class="right-column">
            <iframe src="<?= Url::to(['production-tickets/print', 'id' => $model->id, 'stage' => ProductionStage::STAGE_INSULATION]) ?>" id="preview"></iframe>
        </td>
    </tr>
</table>
