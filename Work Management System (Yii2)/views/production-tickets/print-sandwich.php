...
<head>
    ...
    <title>Печать задания на производство сэндвич-панели стеновой</title>
...
<body onload="onPageLoaded()">
    <h3>Производственное задание на изготовление сэндвич-панели стеновой</h3>
    <table class="top-spacing">
        <tbody>
            <tr class="border-top2">
                ...
                <td><?= $model['number'] ?></td>
                <td></td>
                <td rowspan="9" class="direction"><?= $data['direction'] ?></td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="2" class="bold"><?= $model['outer_type'] ?></td>
                <td class="bold"><?= $model['outer_thickness'] ?></td>
                <td class="bold"><?= $data['outer_coating'] ?></td>
                <td class="bold">RAL <?= $model['outer_color'] ?></td>
            </tr>
            <tr class="border-top2">
            ...
            <tr>
                <td colspan="2" class="bold"><?= $model['inner_type'] ?></td>
                <td class="bold"><?= $model['inner_thickness'] ?></td>
                <td class="bold"><?= $data['inner_coating'] ?></td>
                <td class="bold">RAL <?= $model['inner_color'] ?></td>
            </tr>
    ...
    <table class="top-spacing">
        <tbody>
            ...
            <tr class="border-top2">
                ...
                <td class="bold"><?= $data['outer_coating'] ?></td>
                <td class="bold">RAL <?= $model['outer_color'] ?></td>
                <td class="bold" rowspan="3"><?= $data['area_total'] ?></td>
            </tr>
            <tr class="border-top2">
                <td colspan="2">Внутренняя</td>
                <td>Толщина, мм</td>
            ...
            <tr class="border-top2">
                <td colspan="2"><?= $model['inner_type'] ?></td>
                <td class="bold"><?= $model['inner_thickness'] ?></td>
                <td class="bold"><?= $data['inner_coating'] ?></td>
                <td class="bold">RAL <?= $model['inner_color'] ?></td>
            </tr>
    ...
    <table class="top-spacing">
        <tbody>
        <tr class="border-top2">
            <td class="border" rowspan="2">Контрольный образец</td>
            <td class="border">Сделан</td>
            <td class="border">Проверка замка</td>
            <td class="border">Сделан</td>
            <td class="border">Проверка</td>
        </tr>
        <tr class="border-top2">
            <td class="border">&nbsp;</td>
            <td class="border">&nbsp;</td>
