...
$this->title = 'Печать задания на производство профлиста';
?>
...
<table>
    <tr>
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-6">
                        <div class="form-group">
                            ...
                            <?= Html::dropDownList('type', '35', Product::MM35_TYPES, ['class' => 'form-control']) ?>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-6">
                        <div class="form-group">
        ...
        <td class="right-column">
            <iframe src="<?= Url::to(['production-tickets/print', 'id' => $model->id, 'stage' => ProductionStage::STAGE_MM35]) ?>" id="preview"></iframe>
        </td>
    </tr>
</table>
