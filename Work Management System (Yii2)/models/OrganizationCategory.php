 ...
 */
class OrganizationCategory extends BaseActiveRecord
{
	public $search = '';
    ...
    {
        return $this->hasOne(User::class, ['id' => 'creator_id'])->inverseOf('organizationCategories');
    }
    ...
    {
        return $this->hasOne(User::class, ['id' => 'modifier_id'])->inverseOf('organizationCategories0');
    }
    ...
    {
        return $this->hasMany(Organization::class, ['category_id' => 'id'])->inverseOf('category');
    }
