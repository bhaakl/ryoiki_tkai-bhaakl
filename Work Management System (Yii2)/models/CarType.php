 ...
 * @property int|null $load_capacity Грузоподъёмность, кг
 * @property int|null $length Длина кузова, мм
 * @property int|null $width Ширина кузова, мм
 * @property int|null $height Высота кузова, мм
 ...
 */
class CarType extends BaseActiveRecord
{
	public $search = '';
    ...
    public function rules()
    {
        return [
            ...
            [['load_capacity', 'length', 'width', 'height', 'is_deleted', 'creator_id', 'modifier_id'], 'integer'],
            [['comments'], 'string'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'short_name' => Yii::t('app', 'Код'),
            'load_capacity' => Yii::t('app', 'Грузоподъемность'),
    ...
    {
        return $this->hasMany(Car::class, ['type_id' => 'id'])->inverseOf('type');
    }
    ...
    {
        return $this->hasOne(User::class, ['id' => 'creator_id'])->inverseOf('carTypes');
    }
    ...
    {
        return $this->hasOne(User::class, ['id' => 'modifier_id'])->inverseOf('carTypes0');
    }
