...
/**
 * This is the model class for table "{{%production_location_category}}".
 *
 * @property int $id
 ...
 * @property ProductionLocation[] $productionLocations
 */
class ProductionLocationCategory extends BaseActiveRecord
{
	public $search = '';
    ...
    {
        return '{{%production_location_category}}';
    }
    ...
    {
        return $this->hasOne(User::class, ['id' => 'creator_id'])->inverseOf('productionLocationCategories');
    }
    ...
    {
        return $this->hasOne(User::class, ['id' => 'modifier_id'])->inverseOf('productionLocationCategories0');
    }

    /**
     * Gets query for [[ProductionLocations]].
     *
     * @return \yii\db\ActiveQuery
     */
    public function getProductionLocations()
    {
        return $this->hasMany(ProductionLocation::class, ['category_id' => 'id'])->inverseOf('category');
    }
