 ...
 */
class EquipmentCategory extends BaseActiveRecord
{
	public $search = '';
    /**
     * {@inheritdoc}
    ...
    {
        return $this->hasOne(User::class, ['id' => 'creator_id'])->inverseOf('equipmentCategories');
    }
    ...
    {
        return $this->hasMany(EquipmentUnit::class, ['category_id' => 'id'])->inverseOf('category');
    }
    ...
    {
        return $this->hasOne(User::class, ['id' => 'modifier_id'])->inverseOf('equipmentCategories0');
    }
