...
/**
 * This is the model class for table "{{%salary_payment_category}}".
 *
 * @property int $id
 ...
 */
class SalaryPaymentCategory extends BaseActiveRecord
{
    const TYPE_INCOME = 1;
    const TYPE_OUTCOME = 2;

    const TYPES = [
        self::TYPE_INCOME => 'Начисление',
        self::TYPE_OUTCOME => 'Списание'
    ];

    public function beforeSave($insert)
    {
        $this->type_id = self::TYPE_INCOME;
    ...
    {
        return '{{%salary_payment_category}}';
    }
    ...
    public function getType() {
        return Yii::t('app', self::TYPES[$this->type_id] ?? '');
    }
