...
/**
 * This is the model class for table "{{%mro_work_type}}".
 *
 * @property int $id
 * @property string $name
 * @property string|null $comments Любые комментарии
 * @property int|null $sorting_number
 ...
 */
class MroWorkType extends BaseActiveRecord
{
	public $search = '';
    ...
    public function rules()
    {
        return [
            ...
            [['comments'], 'string'],
            [['sorting_number', 'is_deleted', 'creator_id', 'modifier_id'], 'integer'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'sorting_number' => Yii::t('app', 'Sorting Number'),
    ...
    {
        return $this->hasOne(User::class, ['id' => 'creator_id'])->inverseOf('mroWorkTypes');
    }
    ...
    {
        return $this->hasOne(User::class, ['id' => 'modifier_id'])->inverseOf('mroWorkTypes0');
    }
