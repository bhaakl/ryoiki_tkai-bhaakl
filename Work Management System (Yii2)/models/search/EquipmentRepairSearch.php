 ...
 */
class EquipmentRepairSearch extends EquipmentRepair
{
    public $search = '';
    ...
    public function search($params, $recsOnPage = 20)
    {
        $query = EquipmentRepair::find()
            ...
            ->joinWith('status')
            ->where(['equipment_unit.used_on_equipment_repair' => 1])
        ...
        $query->andFilterWhere(['=', 'equipment_unit.category_id', $this->getAttribute('equipmentUnit.category_id')]);
