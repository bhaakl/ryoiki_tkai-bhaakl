...
/**
 * This is the model class for table "{{%cash_flow_transaction_type}}".
 *
 * @property int $id
 ...
 */
class CashFlowTransactionType extends BaseActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return '{{%cash_flow_transaction_type}}';
    }
    ...
    {
        return $this->hasMany(CashFlowTransactionCategory::class, ['type_id' => 'id'])->inverseOf('type');
    }
}
