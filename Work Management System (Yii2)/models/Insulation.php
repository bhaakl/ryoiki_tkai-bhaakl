 ...
 */
class Insulation extends BaseActiveRecord
{
	public $search = '';
    ...
    {
        return $this->hasOne(User::class, ['id' => 'creator_id'])->inverseOf('insulations');
    }
    ...
    {
        return $this->hasOne(User::class, ['id' => 'modifier_id'])->inverseOf('insulations0');
    }
