...
using BookingApp.UITest.PageModel.Pages;

namespace BookingApp.UITest.PageModel
{
    /// <summary>
    /// Represents the BookingApp web-application.
    /// </summary>
    public class BookingApp : IDisposable
    {
        ...
        public BookingApp(string testrunId, Uri startUrl)
        {
        ...
        public T CreatePage<T>() where T : BookingPage
        {
